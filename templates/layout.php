      ...
      <div class="main-header__side">
        ...
        <div class="main-header__side-item user-menu">
          <div class="user-menu__image">
            <?php if (!empty($_SESSION['user']['url'])) { ?>
            <img src="img/avatars/<?=$_SESSION['user']['url']?>" width="40" height="40" alt="Пользователь">
            <?php } else { ?>
                ...
                <nav class="main-navigation">
                  ...
                  <?php foreach ($projects as $val) : ?>
                    <li class="main-navigation__list-item">
                      <a class="main-navigation__list-item-link" href="index.php?project=<?=$val['id'];?>"><?= $val['name']; ?></a>
                      <span class="main-navigation__list-item-count"><?= getTasksInProject($tasks, $val['id']);?></span>
                    </li>
                  <?php endforeach; ?>
                </nav>
